...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_PbMsg_2eproto[1];
...
const char descriptor_table_protodef_PbMsg_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\013PbMsg.proto\"\030\n\010test_msg\022\014\n\004test\030\001 \001(\005b"
  "\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_PbMsg_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_PbMsg_2eproto_sccs[1] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_PbMsg_2eproto = {
  &descriptor_table_PbMsg_2eproto_initialized, descriptor_table_protodef_PbMsg_2eproto, "PbMsg.proto", 47,
  &descriptor_table_PbMsg_2eproto_once, descriptor_table_PbMsg_2eproto_sccs, descriptor_table_PbMsg_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_PbMsg_2eproto::offsets,
  file_level_metadata_PbMsg_2eproto, 1, file_level_enum_descriptors_PbMsg_2eproto, file_level_service_descriptors_PbMsg_2eproto,
};
